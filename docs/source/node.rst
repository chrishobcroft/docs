...
.. note:: some members have experienced problems getting test eth from the eth faucet - with the error message "nonce too low". If you are experiencing this, or other errors, please contact us at https://gitter.im/livepeer/Lobby with your ETH account address (Account Eth Addr from node status livepeer_cli), and we will send you some test eth.
